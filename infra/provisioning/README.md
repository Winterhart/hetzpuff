...
### Requirement:
Well first thing, all provider-plugin shall be versioned because it's changing
all the time.

- Terraform 11.something is installed
- Wireguard is installed on the machine
- jq is install on the machine
- kubectl is install also.
- You also need to install run this command:
